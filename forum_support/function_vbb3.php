<?php
//########## vbb check begin ######### 3.x vbb½×¾Â±M¥Î
function vbb3_check()
{
	global $_COOKIE, $HTTP_GET_VARS,$root_path,$DB_site, $usercache, $vboptions, $vbphrase, $bbuserinfo, $permissions, $_USEROPTIONS, $phrasegroups, $usergroupcache;
